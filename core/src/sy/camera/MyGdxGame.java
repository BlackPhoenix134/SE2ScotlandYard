...
public class MyGdxGame extends ApplicationAdapter {
    ...
    public MyGdxGame(DeviceCameraControl cameraControl) {
    ...
    public void render () {
        ...
        //Gdx.gl20.glHint(GL30.GL_PERSPECTIVE_CORRECTION_HINT, GL30.GL_NICEST);
        ...
        Gdx.gl20.glEnable(GL30.GL_TEXTURE);
        Gdx.gl20.glEnable(GL30.GL_TEXTURE_2D);
        //Gdx.gl20.glEnable(GL30.GL_LINE_SMOOTH);
        Gdx.gl20.glDepthFunc(GL30.GL_LEQUAL);
        Gdx.gl20.glClearDepthf(1.0F);
        camera.update(true);
        //camera.apply(Gdx.gl20);
        texture.bind();
        for (int i=0;i<6;i++) {
            //mesh[i].render(GL30.GL_TRIANGLE_FAN, 0 ,4);
        }
    ...
    public Pixmap getScreenshot(int x, int y, int w, int h, boolean flipY) {
        ...
        Gdx.gl.glReadPixels(x, y, w, h, GL30.GL_RGBA, GL30.GL_UNSIGNED_BYTE, pixels);
